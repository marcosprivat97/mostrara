...
try {
  ...
  await runMigration("migrate_phase9.mjs", "fase 9");
  await runMigration("migrate_phase10.mjs", "fase 10");
  await runMigration("migrate_phase11.mjs", "fase 11");
  await runMigration("migrate_phase12.mjs", "fase 12");
  await runMigration("migrate_phase13.mjs", "fase 13");
  await runMigration("migrate_phase14.mjs", "fase 14");
  await runMigration("migrate_phase15.mjs", "fase 15");
  await runMigration("migrate_phase16.mjs", "fase 16");
  await runMigration("migrate_phase18.mjs", "fase 18");
  ...
  await runMigration("migrate_phase23.mjs", "fase 23");
  await buildAll();
} catch (err) {
  console.error(err);
  process.exit(1);
