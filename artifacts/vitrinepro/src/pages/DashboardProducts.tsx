...
export default function DashboardProducts() {
  ...
  const openCreate = () => {
    ...
    setPhotos([]);
    reset({ category: "iPhone", condition: "Vitrine", status: "disponivel", name: "", storage: "", price: 0, battery: "", warranty: "", description: "" });
    setDialogOpen(true);
  };
  ...
  const categoryVal = watch("category") || "iPhone";
  const conditionVal = watch("condition") || "Vitrine";
          ...
          <div className="bg-white rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              <DialogDescription className="sr-only">
                {editingProduct ? "Editar informações do produto" : "Adicionar novo produto ao catálogo"}
              </DialogDescription>
              <button
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <FormField label="Bateria" placeholder="95%" {...register("battery")} />
                  <FormField label="Garantia" placeholder="6 meses" {...register("warranty")} />
                </div>
