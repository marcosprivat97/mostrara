...
export default function DashboardStore() {
  ...
  const info = [
    { label: "WhatsApp", value: user?.whatsapp, Icon: Smartphone },
    { label: "Telefone", value: user?.phone, Icon: Phone },
    { label: "Slug da loja", value: `@${user?.store_slug}`, Icon: Link2 },
    {
      label: "Endereço",
      value: [
        user?.store_address,
    ...
    { label: "Cidade", value: user?.city && user?.state ? `${user.city} / ${user.state}` : user?.city, Icon: Store },
  ];
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">Link, dados e visual da sua vitrine publica</p>
      </div>
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="min-w-0">
              <h2 className="text-xl font-bold text-white truncate">{user?.store_name}</h2>
          ...
          {user?.description ? (
            ...
            <p className="text-gray-400 text-sm mb-5 leading-relaxed">
              Adicione uma descricao curta para aumentar a confianca de quem abre sua vitrine.
            </p>
          )}
      ...
      <div className="mb-4">
        <StoreMap
          title="Mapa da loja"
          subtitle={storeAddress || user?.city || "Localização da loja"}
