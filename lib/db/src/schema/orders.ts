...
export const ordersTable = pgTable("orders", {
  ...
  delivery_confirmation_code: text("delivery_confirmation_code").default(""),
  ...
  courier_delivery_photo_url: text("courier_delivery_photo_url").default(""),
  customer_delivery_confirmed_at: timestamp("customer_delivery_confirmed_at"),
  customer_delivery_rating: integer("customer_delivery_rating"),
  customer_delivery_feedback: text("customer_delivery_feedback").default(""),
  customer_delivery_feedback_at: timestamp("customer_delivery_feedback_at"),
